...
type RealtimeGuiClient interface {
	...
	CheckPartial(ctx context.Context, in *CheckPartialRequest, opts ...grpc.CallOption) (*CheckPartialResponse, error)
...
func (c *realtimeGuiClient) CheckPartial(ctx context.Context, in *CheckPartialRequest, opts ...grpc.CallOption) (*CheckPartialResponse, error) {
	out := new(CheckPartialResponse)
	err := c.cc.Invoke(ctx, "/mcl.RealtimeGui/CheckPartial", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RealtimeGuiServer interface {
	...
	CheckPartial(context.Context, *CheckPartialRequest) (*CheckPartialResponse, error)
	// Retrieves raw binlog messages from the backend.
...
func (UnimplementedRealtimeGuiServer) CheckPartial(context.Context, *CheckPartialRequest) (*CheckPartialResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckPartial not implemented")
}
...
func _RealtimeGui_CheckPartial_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckPartialRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RealtimeGuiServer).CheckPartial(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mcl.RealtimeGui/CheckPartial",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealtimeGuiServer).CheckPartial(ctx, req.(*CheckPartialRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RealtimeGui_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckPartial",
			Handler:    _RealtimeGui_CheckPartial_Handler,
		},
		{
