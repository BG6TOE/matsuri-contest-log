...
func (c *binlogClient) GetActiveContest(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ActiveContest, error) {
...
func (UnimplementedBinlogServer) GetActiveContest(context.Context, *emptypb.Empty) (*ActiveContest, error) {
...
func _Binlog_GetActiveContest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BinlogServer).GetActiveContest(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
